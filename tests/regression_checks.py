...
require("v3.31 metadata and shared panel version", "// @version      3.31" in text and "const SCRIPT_VERSION = '3.31';" in text and "v${SCRIPT_VERSION}" in text)
...
require("panel scheduler information stays compact", "#dxzxx-sched-status{max-height:54px" in text)
