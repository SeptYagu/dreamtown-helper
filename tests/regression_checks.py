...
require("v3.59 metadata and shared panel version", "// @version      3.59" in text and "const SCRIPT_VERSION = '3.59';" in text and "v${SCRIPT_VERSION}" in text)
...
require("panel fills mailbox numbering with a reference", "planReferenceLabels" in text and "见左上餐厅子开关" in text and "class=\"plan-ref\"" in text)
require("panel groups daily projects as one continuously numbered item", "dailyProjectModules = ['dailyNpc', 'dailyFriend', 'dailyBar', 'dailyLuck', 'extraWish']" in text and "${displayStep}. 每日项目" in text and "见上方每日项目配置" in text)
...
require("daily luck syncs server progress", "今日已沾光[：:\\s]*(\\d+)\\s*\\/\\s*3" in luck and "Math.max(state.counts.luck || 0" in luck)
...
require("daily luck has two exact 31-minute checks", "id: 'dailyLuck1031'" in daily and "slot: '10:31', jitterMin: 0, jitterMax: 0" in daily and "id: 'dailyLuck1131'" in daily and "slot: '11:31', jitterMin: 0, jitterMax: 0" in daily)
