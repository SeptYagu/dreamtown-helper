...
require("v3.40 metadata and shared panel version", "// @version      3.40" in text and "const SCRIPT_VERSION = '3.40';" in text and "v${SCRIPT_VERSION}" in text)
...
require("global stop button is permanent and reserves its row", "⏹ 停止当前操作（Esc）" in text and "#dxzxx-stop{grid-column:1/-1;}" in text and "dxzxx-stop\" style=\"background:#f44;color:#fff;display:none" not in text)
