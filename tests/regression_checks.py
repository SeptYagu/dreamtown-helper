...
require("v3.30 metadata and shared panel version", "// @version      3.30" in text and "const SCRIPT_VERSION = '3.30';" in text and "v${SCRIPT_VERSION}" in text)
...
require("panel informational lists stay compact", "max-height:72px" in text and "#dxzxx-sched-status{max-height:54px" in text)
