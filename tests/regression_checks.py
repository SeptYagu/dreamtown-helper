...
require("v3.62 metadata and shared panel version", "// @version      3.62" in text and "const SCRIPT_VERSION = '3.62';" in text and "v${SCRIPT_VERSION}" in text)
...
require("panel merges restaurant and mailbox into one numbered row", "if (step.module === 'mailbox') return;" in text and "GROUP_RUN_DEFS.restaurantAndMailbox.modules.join(',')" in text and "餐厅管理 <span class=\"plan-ref\">（含系统邮箱，见左上子开关）" in text)
